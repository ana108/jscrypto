...
let p = new Point(2, 2)
for (let i = 1; i < 13; i++) {
    console.log(`The inverse of ${i} is ${p.egcd(13, i)}`);
}
// let arrayOfPoints = []
...
// }
// let onePoint = new Point(2, 3)
// let finalPoint = onePoint.addPoint(new Point(2, 3))
// console.log(`Final Point x: ${finalPoint.x} y: ${finalPoint.y} and check is ${finalPoint.check()}`)